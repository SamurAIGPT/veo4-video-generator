...
export function Navbar() {
  ...
  return (
    <nav className="h-20 border-b border-glass-border bg-glass-bg backdrop-blur-3xl sticky top-0 z-[100] px-4 md:px-12 flex items-center justify-between">
      ...
      <div className="hidden lg:flex items-center gap-1 bg-glass-hover p-1 rounded-md border border-glass-border absolute left-1/2 -translate-x-1/2">
        {navLinks.map((link) => {
      ...
      <div className="flex items-center gap-4 shrink-0">
        ...
        <a 
          href="https://vercel.com/new/clone?repository-url=https://github.com/SamurAIGPT/veo4-video-generator"
          target="_blank"
